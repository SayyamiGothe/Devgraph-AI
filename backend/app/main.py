...
from app.graph.neo4j_client import close_driver, ensure_schema
...
from app.api.code_repository.router import (
    router as code_repository_router,
)
...
app.include_router(code_repository_router)